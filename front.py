...
from metrics import MetricsTracker, MetricsDashboard
...
class PDFLibraryApp:
            ...
            st.markdown("""
                <div style="
                    ...
                    <h1 style="
                        ...
                        Personal AI Library - Simplify Your Life
                    </h1>
                    <h2 style="
                        margin: 0; 
                        padding: 0; 
   ...
   # @st.cache_data
    ...
    def show_book_details(self, book):
        ...
        # Book details section with dark theme styling
        st.markdown(f"""
            <div style="
                background-color: #1E0935;
                padding: 1.5rem;
    ...
    def display_content_block(self, content):
        """Helper method to display content block with consistent dark theme styling"""
        st.markdown(f"""
            <div style="
                background-color: #1E0935;
                color: #FFFFFF
