...
class DashboardPage:
    ...
    def add_bg_image(self):
        ...
        st.markdown(
            ...
            <style>
                .stApp {{
                    background-image: url("https://i.postimg.cc/GpPDcHDK/Picture113.png");
    ...
    def create_metric_with_info(self, title, value, trend_value, trend_direction, info_text, key_suffix=None):
        ...
        col1, col2 = st.columns([5, 1])
        with col1:
            self.create_metric_card_with_trend(
                title,
                value,
                trend_value,
                trend_direction  
        ...
        with col2:
            # Create a unique key using title and uuid
    ...
    def create_metric_card_with_trend(self, title, value, trend_value=None, trend_direction=None):
        ...
        st.markdown(
            ...
            ">
                <h3 style="color: #f9fafb; margin-bottom: 10px; font-size: 1em;">{title}</h3>
                <p style="font-size: 1.8em; font-weight: bold; color: #60a5fa; margin: 0;">{value}</p>
                <p style="font-size: 0.9em; color: {trend_color}; margin-top: 5px;">
    ...
    def apply_modern_clean_style(self, fig, title):
        """Apply modern clean styling to charts"""
        fig.update_layout(
            plot_bgcolor='#252f3e',
            paper_bgcolor='#11001C', 
            margin=dict(t=60, l=50, r=30, b=40),  # Increase top margin to make room for the title
            title=dict(
                text=title,
                font=dict(
                    family="Arial",
                    size=24,  # Increase font size for better visibility
                    color="#f9fafb"
                ),  
                x=0.6,  # Center the title horizontally
                y=0.98,  # Adjust the vertical position of the title
                xanchor='right',  # Anchor the title at the center
                yanchor='top'  # Anchor the title at the top
            ),
            xaxis=dict(
                title_font=dict(size=14, color="#f9fafb", family="Arial"),
                tickfont=dict(size=12, color="#f9fafb", family="Arial"),
                showgrid=True,
                gridwidth=1,
                    ...
                    with tabs[0]:
                        st.markdown("""
                            <div style="
                                ...
                                margin-bottom: 10px;
                            ">
                            <h2 style="color: #f9fafb;">System Health Overview</h2>
                            </div>
                        """, unsafe_allow_html=True)
                        ...
                        if quality_metrics:
                            st.markdown("""
                                <div style="
                                    ...
                                    margin-bottom: 10px;
                                ">
                                <h2 style="color: #f9fafb;">Document Quality Overview</h2>
                                </div>
                            """, unsafe_allow_html=True)
                            ...
                            st.markdown("""
                                <div style="padding: 20px; background-color: #252f3e; border-radius: 10px; margin-top: 20px;">
                                    <h4 style="color: #f9fafb;">📊 Quality Metrics Explanation</h4>
                                    <ul style="color: #f9fafb;">
                                        <li><strong>Total Documents:</strong> Number of documents in the system</li>
                                        <li><strong>Documents Accessed:</strong> Percentage of documents that have been queried</li>
                                        <li><strong>Performance Score:</strong> Overall system performance rating</li>
                                        <li><strong>Documents with Errors:</strong> Number of documents with processing issues</li>
                                    </ul>
                                </div>
                            """, unsafe_allow_html=True)
